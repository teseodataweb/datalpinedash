                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Bloquear pantalla</h5>
                                    <p class="text-muted mt-2">¡Ingresa tu contraseña para desbloquear la pantalla!</p>
                                </div>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">©
                                    <script>document.write(new Date().getFullYear())</script> DatAlpine
                                </p>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <div class="testi-contain text-white">
                                                ...
                                                <h4 class="mt-4 fw-medium lh-base text-white">“Me siento seguro al
                                                    imponerme cambios. Es mucho más divertido progresar que mirar hacia
                                                    atrás. Es por eso que me gusta la malesuada nibh diam de tortor,
                                                    necesario para lanzar bolas curvas.”
                                                </h4>
