...
<div class="auth-page">
    <div class="container-fluid p-0 ">
        <div class="row g-0">            
            <div class="row justify-content-center align-items-center" style="background-image: url('/datalpine/public/Admin/assets/images/index_image.png'); background-size: cover;">
            <!--<div class="col-xxl-3 col-lg-4 col-md-5 ficha">-->                
                <div class="col-xxl-3 col-lg-4 col-md-5" style="background-color: #ffffff; box-shadow: 0 0 20px 0 rgba(169, 169, 169, 0.5);">
