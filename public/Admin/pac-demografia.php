            ...
            <div class="container-fluid">
                ...
                <div class="row align-items-center"
                    ...
                    <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                        <?php
                        echo "<li style='font-size: 20px;'>1.2 Distribución de la población de Pachuca por género y rango de edad</li>";
                        echo "</ol>";
                        echo "</ol>";
                        ?>
                        <!-- Link de la gráfica -->
                    ...
                    <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                        ...
                        <p style="text-align: center;">
                            <iframe width="1000" height="400" seamless frameborder="0" scrolling="no"
                                src="/datalpine/resources/jupyter/graficas/g_bar_porcentaje_vivienda_ofertadas_antigüedad_pachuca.html"></iframe>
                        </p>
                        <!-- Explicación de la gráfica -->
                        <div class="mostrar-container">
