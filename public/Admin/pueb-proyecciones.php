        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <!--<iframe src="/datalpine/resources/jupyter/graficas/g_scatt_preciomediaanual_direct_pachuca.html"
                            ></iframe>-->
                            <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=2101813011&format=interactive" 
                ...
                <div class="row align-items-center"
                    ...
                    <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                        <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=1792522628&format=interactive" 
                                width="800" height="400" frameborder="0" id="contenido01"
                                style="display: block; margin: 0 auto;"></iframe>
                    </div>
                    ...
                    <div class="interpretation" id="interpretación1" style="display: none;">
                        <p class="text">
                        Los datos revelan una proyección ascendente en la plusvalía del precio promedio de las viviendas en Puebla para los próximos años. En el año 2023, se muestra un valor de $3,509,691.82, evidenciando un crecimiento significativo que se espera continúe de manera constante hasta alcanzar $3,884,109.69 en el año 2027.
                        </p>
                    </div>
                </div>
                ...
                <div class="row align-items-center"
                    ...
                    <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                        <!-- Link de la gráfica -->
                        <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=721593060&format=interactive" 
                                width="800" height="400" frameborder="0" id="contenido01"
                                style="display: block; margin: 0 auto;"></iframe>
                        <!-- Explicación de la gráfica -->
                        <div class="mostrar-container">
                    ...
                    <div class="interpretation" id="interpretación22" style="display: none;">
                        <p class="text">
                        Entre los años 2019 y 2021, se observó una variación significativa en el número total de créditos, alcanzando niveles destacados durante esos años. Sin embargo, en 2022, se registra una marcada disminución en el total de créditos.
                        </p>
                        <p class="text">                        En cuanto a las proyecciones para las categorías "Vivienda Nueva" y "Vivienda Usada", ambas muestran patrones similares de mantenimiento en 2022, con un ligero repunte anticipado en los años que siguen a este periodo. Se espera que la categoría de "Vivienda Nueva" experimente un crecimiento constante alcanzando 1,083 créditos en el año 2026, mientras que la categoría de "Vivienda Usada" se proyecta a recuperarse hasta alcanzar 1,100 créditos en el mismo año.
                        </p>
                    </div>
                </div>
                ...
                <div class="row align-items-center"
                    ...
                    <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                        ...
                        <div class="card-header bg-white d-flex justify-content-center align-items-center">
                            <div class="d-flex align-items-center">
                                <iframe width="1000" height="400" seamless frameborder="0" scrolling="no"
                                    src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=1228184625&format=interactive"
                                    id="contenido8"></iframe>                                    
                                <iframe width="1000" height="400" seamless frameborder="0" scrolling="no"
                                    src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=1221224799&format=interactive"
                        ...
                        <!-- Explicación de la gráfica -->
                        <div class="mostrar-container">
                            <button class="mostrar" onclick="toggleDescription('description3', 'interpretación3',this)">Monto total</button>
                            <button class="mostrar" onclick="toggleDescription('interpretación3', 'description3',this)"> Monto promedio</button>
                        </div>
                        <!-- Descripción -->
                        <div class="description" id="description3" style="display: none;">
                            <p class="text">
                            El monto total de créditos en Puebla presenta una proyección ascendente, estimándose un aumento de $1,539,276.52 en 2020 a $2,747,487.65 en 2028. Esta tendencia refleja un crecimiento constante a lo largo del periodo analizado.
Para vivienda nueva se observa una disminución gradual de $1,585,803.75 en 2019 a $2,747,787.65 en 202 evidenciando una estabilidad y crecimiento constante en los años posteriores.
Por otro lado, los créditos destinados a la "Vivienda Usada" aunque se registran fluctuaciones, destaca un incremento progresivo de $1,585,803,756.76en 2019 a $2,747,487,656.04 en 2026.
                            </p>
                        </div>
                    </div>
                    <!-- Interpretación -->
                    <div class="interpretation" id="interpretación3" style="display: none;">
                    <p class="text"> Para todas las categorías, se evidencia un crecimiento constante de $ 1,331,489.30 en 2019 a $2,502,265.63 en 2028.
En relación a "Vivienda Nueva" en Puebla, se observa una trayectoria ascendente en los montos promedio por crédito a lo largo de los años proyectados. Desde $1,653,343.33 en 2019, se anticipa un crecimiento constante hasta alcanzar $2,320,787.50 en 2028.

En cuanto a la categoría de "Vivienda Usada" en Puebla, se observa una variación en los montos promedio por crédito a lo largo de los años proyectados. Partiendo de $1,331,489.30 en 2019, se experimenta un aumento a $2,502,265.63 en 2028
                        </p>
                ...
                <div class="row align-items-center"
                    ...
                    <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                        <!-- Link de la gráfica -->
                        <iframe
                            src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=1630974419&format=interactive"
                            width="800" height="400" frameborder="0" id="contenido01"
                            style="display: block; margin: 0 auto;"></iframe>
                        <!-- Explicación de la gráfica -->
                        <div class="mostrar-container">
                            <button class="mostrar" onclick="toggleDescription('description4', 'interpretación4',this)">Interpretación</button>
                        ...
                        <div class="description" id="description4" style="display: none;">
                            <p class="text">
                            La línea azul representa la cantidad de cambio en la oferta de casas. Comienza con 2744 propiedades en junio de 2024, se espera un aumento a un 2818 en agosto del mismo año, y se mantiene en el mes siguiente. Esto indica un aumento en la oferta de casas durante este período.
                            </p>
                            <p class="text">                            La línea roja representa la cantidad de cambio en la oferta de departamentos. De acuerdo a la tendencia comienza con un aumento de 1125 a 1129 en julio de 2024, para el mes siguiente aumenta ligeramente a 1132 propiedades y se mantiene constante durante el siguiente mes. Esto sugiere que la oferta de departamentos se mantiene en aumento pero en menor medida comparada a las casas durante este período.
                            </p>
                        </div>
                    </div>
                    <!-- Interpretación -->
                ...
                <div class="row align-items-center"
                    ...
                    <div class="interpretation" id="interpretación5" style="display: none;">
                        <ul class="text">
                            <li>El análisis de la información revela que la categoría con el mayor número de unidades es la de "101-365 días", con un total de 1808 unidades. Este intervalo de tiempo indica que una cantidad significativa de unidades inmobiliarias permanecen en el mercado durante un periodo relativamente prolongado antes de concretar la venta.
                            </li>
                            <li>Por otro lado, la categoría con el menor número de unidades es la de "11-30 días", que registra 51 unidades.
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row align-items-center"
                    ...
                    <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                        <!-- Link de la gráfica -->
                        <iframe
                            src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=1350457785&format=interactive" width="1100"
                            height="400" frameborder="0" id="contenido01" 
                            style="display: block; margin-left:100px;"></iframe>
                    ...
                    <div class="interpretation" id="interpretación6" style="display: none;">
                        <p class="text">
                            La estimación poblacional revela un crecimiento progresivo en la región a lo largo de los años 2020 a 2026. Iniciando con 6,583,278 habitantes en 2020, la población experimenta un incremento constante, alcanzando los 7,399,676 habitantes en 2026.
                        </p>
                    </div>
            ...
            <div class="row align-items-center"
                ...
                <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                    <!-- Link de la gráfica -->
                    <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=258417594&format=interactive" width="800"
                ...
                <div class="interpretation" id="interpretación7" style="display: none;">
                    <p class="text">
                        En este contexto, las casas que llevan más de un año en stock (23.5%) representan un riesgo menor en términos de porcentaje, pero aún así indican una proporción significativa. Por otro lado, las casas que llevan menos de un año en stock representan la mayoría en términos porcentuales <strong>(76.5%)</strong> e indican una rotación más activa del inventario.
                    </p>
                </div>
            </div>
            <!-- Proyección en días -->
            <div class="row align-items-center"
                ...
                <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                    <!-- Link de la gráfica -->
                    <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vT1_O39XKc1VRRPdKyfpbswGydj3jUBSTJKITqNC08MVRrdkrd_eHkXhangR30RoEFZgC9zxvjGDa55/pubchart?oid=128704229&format=interactive" width="800"
                        height="400" frameborder="0" id="contenido01" style="display: block; margin: 0 auto;"></iframe>
                ...
                <div class="interpretation" id="interpretación8" style="display: none;">
                    <ul class="text">
                        <li>En el historial de stock, se evidencia una duración de 178 días en junio de 2024, seguida de un aumento a 181 días en julio y 183 días en agosto . La proyección para septiembre sugiere una continuación de esta tendencia, con estimaciones de 185 días respectivamente.
                        </li>
            ...
            <div class="row align-items-center"
                ...
                <div style="border-top: 1px solid #ccc; padding-top: 20px; margin-top: 20px;">
                    ...
                    <!-- Descripción --                    <div class="description" id="description12" style="display: none;">
                        <p class="text">
