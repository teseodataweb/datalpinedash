...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-09-2024 a las 04:39:55
...
--
-- Estructura de tabla para la tabla `alfa_marzo_2024_tulancingo`
--

CREATE TABLE `alfa_marzo_2024_tulancingo` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `alfa_marzo_2024_tulancingo`
--

INSERT INTO `alfa_marzo_2024_tulancingo` (`id`, `Categoria`, `Precio`, `propiedad`, `metros_total`, `metros_construido`, `precio_m2_terreno`, `precio_m2_construido`, `tiempo_de_publicacion`, `Estado`, `Tipo`, `Estacionamientos`, `Recamaras`, `Banos`, `Medio_banos`, `Banos_Total`, `Seguridad`, `Colonia`, `CP`, `url`) VALUES
...
(111, 'S1', 4500000.00, 'Se vende casa en Tulancingo, Fraccionamiento San Francisco Huatengo.', 0, 0, 0.00, 0.00, 8, 'Venta', 'Casa', 2, 4, 3, 0.00, 3.00, 0, 'La Quinta', '43660', 'https://www.lamudi.com.mx/detalle/41032-73-cfbd09274c36-b108-c2a1f4e9-ad07-1237'),
...
--
-- Indices de la tabla `alfa_marzo_2024_tulancingo`
--
ALTER TABLE `alfa_marzo_2024_tulancingo`
  ADD PRIMARY KEY (`id`);
COMMIT;
